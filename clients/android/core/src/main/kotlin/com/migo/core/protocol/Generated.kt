...
val OPCODES: Map<Long, OpcodeMeta> = mapOf(
    1L to OpcodeMeta(1L, "HELLO", 5, DeliveryClass.Critical, AuthLevel.None, Direction.ClientToServer, false, "Hello", "Welcome", null, false, listOf()),
    2L to OpcodeMeta(2L, "PING", 1, DeliveryClass.Critical, AuthLevel.None, Direction.Both, false, "Ping", "Pong", null, false, listOf()),
    3L to OpcodeMeta(3L, "ACK", 0, DeliveryClass.Critical, AuthLevel.None, Direction.ClientToServer, false, "Ack", null, null, false, listOf()),
    4L to OpcodeMeta(4L, "ERROR", 0, DeliveryClass.Critical, AuthLevel.None, Direction.ServerToClient, false, "Error", null, null, false, listOf()),
    5L to OpcodeMeta(5L, "RECONNECT_HINT", 0, DeliveryClass.Critical, AuthLevel.None, Direction.ServerToClient, false, "ReconnectHint", null, null, false, listOf()),
    6L to OpcodeMeta(6L, "AUTHENTICATE", 10, DeliveryClass.Critical, AuthLevel.None, Direction.ClientToServer, false, "Authenticate", "Authenticated", null, false, listOf()),
    7L to OpcodeMeta(7L, "SUBSCRIBE", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "SubscribeRequest", "SubscribeResponse", null, false, listOf()),
    8L to OpcodeMeta(8L, "UNSUBSCRIBE", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "SubscribeRequest", "SubscribeResponse", null, false, listOf()),
    16L to OpcodeMeta(16L, "KEY_PUBLISH", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "KeyPublish", "KeyPublishResult", null, false, listOf()),
    17L to OpcodeMeta(17L, "KEY_BUNDLE_FETCH", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "KeyBundleRequest", "KeyBundleResponse", null, false, listOf()),
    32L to OpcodeMeta(32L, "MESSAGE_SEND", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MessageSend", "MessageAccepted", null, false, listOf()),
    33L to OpcodeMeta(33L, "MESSAGE_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, true, "MessageEvent", null, null, false, listOf()),
    34L to OpcodeMeta(34L, "MESSAGE_RECEIPT", 1, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "MessageReceipt", null, null, false, listOf()),
    35L to OpcodeMeta(35L, "MESSAGE_DELETE", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MessageDelete", "MessageAccepted", null, false, listOf()),
    36L to OpcodeMeta(36L, "SYNC", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "SyncRequest", "SyncResponse", null, false, listOf()),
    37L to OpcodeMeta(37L, "CONVERSATION_LIST", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationListRequest", "ConversationListResponse", null, false, listOf()),
    38L to OpcodeMeta(38L, "CONVERSATION_CREATE", 10, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationCreateRequest", "ConversationSummary", null, false, listOf()),
    39L to OpcodeMeta(39L, "TYPING", 1, DeliveryClass.Coalescable, AuthLevel.User, Direction.Both, false, "TypingEvent", null, "conversation_id", false, listOf("UltraLowData")),
    40L to OpcodeMeta(40L, "MESSAGE_EDIT", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MessageEdit", "Acknowledged", null, false, listOf()),
    41L to OpcodeMeta(41L, "REACTION_SET", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ReactionSet", "Acknowledged", null, false, listOf()),
    42L to OpcodeMeta(42L, "REACTION_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "ReactionEvent", null, "target_message_id+actor_id", false, listOf()),
    43L to OpcodeMeta(43L, "CONVERSATION_INVITE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationInviteRequest", "ConversationSummary", null, false, listOf()),
    44L to OpcodeMeta(44L, "CONVERSATION_LEAVE", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationLeaveRequest", "Acknowledged", null, false, listOf()),
    45L to OpcodeMeta(45L, "CONVERSATION_ROSTER", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationRosterRequest", "ConversationRosterResponse", null, false, listOf()),
    46L to OpcodeMeta(46L, "CONVERSATION_MUTE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationMuteRequest", "Acknowledged", null, false, listOf()),
    47L to OpcodeMeta(47L, "CONVERSATION_KICK", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationKickRequest", "Acknowledged", null, false, listOf()),
    48L to OpcodeMeta(48L, "CONVERSATION_VOTE_KICK", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationVoteKickRequest", "ConversationVoteKickResponse", null, false, listOf()),
    49L to OpcodeMeta(49L, "CONVERSATION_VOTE_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "ConversationVoteEvent", null, "conversation_id", false, listOf()),
    50L to OpcodeMeta(50L, "CONVERSATION_MEMBER_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "ConversationMemberEvent", null, null, false, listOf()),
    51L to OpcodeMeta(51L, "CONVERSATION_UPDATE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationUpdateRequest", "ConversationSummary", null, false, listOf()),
    64L to OpcodeMeta(64L, "PRESENCE_SET", 1, DeliveryClass.Coalescable, AuthLevel.User, Direction.ClientToServer, false, "PresenceUpdate", "Acknowledged", null, false, listOf()),
    65L to OpcodeMeta(65L, "PRESENCE_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "PresenceEvent", null, "user_id", true, listOf()),
    80L to OpcodeMeta(80L, "ROOM_JOIN", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomJoinRequest", "RoomJoinResponse", null, false, listOf()),
    81L to OpcodeMeta(81L, "ROOM_LEAVE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomLeaveRequest", "Acknowledged", null, false, listOf()),
    82L to OpcodeMeta(82L, "ROOM_LIST", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomListRequest", "RoomListResponse", null, false, listOf()),
    83L to OpcodeMeta(83L, "ROOM_MEMBER_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "RoomMemberEvent", null, null, false, listOf()),
    84L to OpcodeMeta(84L, "ROOM_STATE_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "RoomStateEvent", null, "room_id", false, listOf()),
    85L to OpcodeMeta(85L, "ROOM_CREATE", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomCreate", "RoomJoinResponse", null, false, listOf()),
    86L to OpcodeMeta(86L, "ROOM_ROSTER", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RosterReq", "RosterResponse", null, false, listOf()),
    87L to OpcodeMeta(87L, "ROOM_ROLE_SET", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomRoleSet", "Acknowledged", null, false, listOf()),
    88L to OpcodeMeta(88L, "ROOM_UPDATE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomUpdate", "Acknowledged", null, false, listOf()),
    89L to OpcodeMeta(89L, "ROOM_ARCHIVE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomArchive", "Acknowledged", null, false, listOf()),
    90L to OpcodeMeta(90L, "ROOM_VOTE_KICK", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomVoteKick", "RoomVoteKickResponse", null, false, listOf()),
    91L to OpcodeMeta(91L, "ROOM_VOTE_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "RoomVoteEvent", null, "room_id", false, listOf()),
    92L to OpcodeMeta(92L, "ROOM_SANCTION", 10, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomSanction", "Acknowledged", null, false, listOf()),
    111L to OpcodeMeta(111L, "PROFILE_UPDATE", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ProfileUpdate", "UserProfile", null, false, listOf()),
    112L to OpcodeMeta(112L, "PROFILE_FETCH", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ProfileRequest", "ProfileResponse", null, false, listOf()),
    113L to OpcodeMeta(113L, "FRIEND_REQUEST", 10, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "FriendTarget", "Acknowledged", null, false, listOf()),
    114L to OpcodeMeta(114L, "FRIEND_RESPOND", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "FriendRespond", "Acknowledged", null, false, listOf()),
    115L to OpcodeMeta(115L, "FRIEND_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "FriendEvent", null, null, false, listOf()),
    116L to OpcodeMeta(116L, "BLOCK_SET", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "FriendTarget", "Acknowledged", null, false, listOf()),
    117L to OpcodeMeta(117L, "RELATIONSHIP_LIST", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RelationshipListReq", "RelationshipList", null, false, listOf()),
    118L to OpcodeMeta(118L, "SUGGESTIONS", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "SuggestReq", "SearchResponse", null, false, listOf()),
    119L to OpcodeMeta(119L, "SEARCH", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "SearchReq", "SearchResponse", null, false, listOf()),
    120L to OpcodeMeta(120L, "MUTE_SET", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MuteSet", "Acknowledged", null, false, listOf()),
    128L to OpcodeMeta(128L, "MEDIA_UPLOAD_BEGIN", 10, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MediaBegin", "MediaTicket", null, false, listOf()),
    129L to OpcodeMeta(129L, "MEDIA_UPLOAD_STATUS", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MediaStatusReq", "MediaProgress", null, false, listOf()),
    130L to OpcodeMeta(130L, "MEDIA_UPLOAD_COMMIT", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MediaCommit", "Acknowledged", null, false, listOf()),
    131L to OpcodeMeta(131L, "MEDIA_UPLOAD_ABORT", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MediaAbort", "Acknowledged", null, false, listOf()),
    132L to OpcodeMeta(132L, "MEDIA_FETCH_URL", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MediaFetch", "MediaUrl", null, false, listOf()),
    133L to OpcodeMeta(133L, "MEDIA_STATE_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "MediaStateEvent", null, "object_id", false, listOf()),
    144L to OpcodeMeta(144L, "NOTIFICATION_EVENT", 0, DeliveryClass.Droppable, AuthLevel.User, Direction.ServerToClient, false, "NotificationEvent", null, null, false, listOf()),
    145L to OpcodeMeta(145L, "NOTIFICATION_ACK", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "NotificationAck", "Acknowledged", null, false, listOf()),
    146L to OpcodeMeta(146L, "NOTIFICATION_LIST", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "InboxReq", "InboxResponse", null, false, listOf()),
    147L to OpcodeMeta(147L, "PUSH_REGISTER", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "PushRegister", "Acknowledged", null, false, listOf()),
    148L to OpcodeMeta(148L, "PUSH_UNREGISTER", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "PushUnregister", "Acknowledged", null, false, listOf()),
    160L to OpcodeMeta(160L, "GIFT_SEND", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GiftSend", "GiftSendResult", null, false, listOf()),
    161L to OpcodeMeta(161L, "BALANCE_FETCH", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "WalletReq", "WalletView", null, false, listOf()),
    162L to OpcodeMeta(162L, "ECONOMY_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "EconomyEvent", null, null, false, listOf()),
    163L to OpcodeMeta(163L, "GIFT_CATALOGUE", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GiftCatalogueReq", "GiftCatalogueResponse", null, false, listOf()),
    164L to OpcodeMeta(164L, "LEDGER_HISTORY", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "LedgerReq", "LedgerResponse", null, false, listOf()),
    165L to OpcodeMeta(165L, "PROGRESSION", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ProgressionReq", "ProgressionWire", null, false, listOf()),
    166L to OpcodeMeta(166L, "BADGES", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "BadgesReq", "BadgesResponse", null, false, listOf()),
    167L to OpcodeMeta(167L, "LEADERBOARD", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "LeaderboardReq", "LeaderboardResponse", null, false, listOf()),
    176L to OpcodeMeta(176L, "GAME_ACTION", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GameAction", "Acknowledged", null, false, listOf()),
    177L to OpcodeMeta(177L, "GAME_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "GameEvent", null, null, false, listOf()),
    178L to OpcodeMeta(178L, "BOT_COMMAND", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "BotCommand", "Acknowledged", null, false, listOf()),
    179L to OpcodeMeta(179L, "BOT_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "BotEvent", null, null, false, listOf()),
    180L to OpcodeMeta(180L, "BOT_REGISTER", 20, DeliveryClass.Critical, AuthLevel.Bot, Direction.ClientToServer, false, "BotRegister", "BotView", null, false, listOf()),
    183L to OpcodeMeta(183L, "GAME_START", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GameStart", "GameViewWire", null, false, listOf()),
    184L to OpcodeMeta(184L, "GAME_VIEW", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GameId", "GameViewWire", null, false, listOf()),
    185L to OpcodeMeta(185L, "GAME_ABANDON", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GameId", "Acknowledged", null, false, listOf()),
    186L to OpcodeMeta(186L, "GAME_CATALOGUE", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GiftCatalogueReq", "GameCatalogueResponse", null, false, listOf()),
    192L to OpcodeMeta(192L, "REPORT_CREATE", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ReportFile", "Acknowledged", null, false, listOf()),
    193L to OpcodeMeta(193L, "MODERATION_ACTION", 10, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ModAction", "Acknowledged", null, false, listOf()),
    194L to OpcodeMeta(194L, "MODERATION_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "ModerationEvent", null, null, false, listOf()),
    208L to OpcodeMeta(208L, "FED_HELLO", 5, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedHello", "FedHello", null, false, listOf()),
    209L to OpcodeMeta(209L, "FED_AUTH", 5, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedAuth", "Acknowledged", null, false, listOf()),
    210L to OpcodeMeta(210L, "FED_PING", 1, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedPing", "FedPong", null, false, listOf()),
    211L to OpcodeMeta(211L, "FED_FORWARD", 1, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedForward", "Acknowledged", null, false, listOf()),
    212L to OpcodeMeta(212L, "FED_ACK", 0, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedAck", "Acknowledged", null, false, listOf()),
    213L to OpcodeMeta(213L, "FED_ROOM_SUBSCRIBE", 2, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedRouting", "Acknowledged", null, false, listOf()),
    214L to OpcodeMeta(214L, "FED_ROOM_EVENT", 0, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedRoomEvent", "Acknowledged", null, false, listOf()),
    215L to OpcodeMeta(215L, "FED_PRESENCE_DIGEST", 0, DeliveryClass.Coalescable, AuthLevel.Server, Direction.Both, false, "FedPresenceDigest", "Acknowledged", "region", false, listOf()),
    216L to OpcodeMeta(216L, "FED_KEY_ROTATE", 5, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedKeyRotate", "Acknowledged", null, false, listOf()),
    217L to OpcodeMeta(217L, "FED_HEALTH", 1, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedHealth", "FedHealth", null, false, listOf()),
    218L to OpcodeMeta(218L, "FED_SHARD_MAP", 2, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedShardMap", "Acknowledged", null, false, listOf()),
    219L to OpcodeMeta(219L, "FED_ERROR", 0, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedError", "Acknowledged", null, false, listOf()),
    220L to OpcodeMeta(220L, "FED_CALL_RELAY", 1, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedForward", "Acknowledged", null, false, listOf()),
    221L to OpcodeMeta(221L, "FED_DIRECTORY", 2, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedDirectoryReq", "FedDirectory", null, false, listOf()),
    224L to OpcodeMeta(224L, "CALL_INVITE", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "CallInvite", "CallInviteResult", null, false, listOf()),
    225L to OpcodeMeta(225L, "CALL_INVITE_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "CallInviteEvent", null, null, false, listOf()),
    226L to OpcodeMeta(226L, "CALL_ANSWER", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "CallAnswer", "Acknowledged", null, false, listOf()),
    227L to OpcodeMeta(227L, "CALL_DECLINE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "CallDecline", "Acknowledged", null, false, listOf()),
    228L to OpcodeMeta(228L, "CALL_CANCEL", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "CallCancel", "Acknowledged", null, false, listOf()),
    229L to OpcodeMeta(229L, "CALL_END", 2, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "CallEnd", "Acknowledged", null, false, listOf()),
    230L to OpcodeMeta(230L, "CALL_SDP", 3, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "CallSdp", "Acknowledged", null, false, listOf()),
    231L to OpcodeMeta(231L, "CALL_ICE", 1, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "CallIce", "Acknowledged", null, false, listOf()),
    232L to OpcodeMeta(232L, "CALL_STATE_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "CallStateEvent", null, null, false, listOf()),
    233L to OpcodeMeta(233L, "CALL_RENEGOTIATE", 3, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "CallRenegotiate", "Acknowledged", null, false, listOf()),
    234L to OpcodeMeta(234L, "CALL_KEY_UPDATE", 3, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "CallKeyUpdate", "Acknowledged", null, false, listOf()),
    235L to OpcodeMeta(235L, "CALL_STATS", 1, DeliveryClass.Droppable, AuthLevel.User, Direction.ClientToServer, false, "CallStats", "Acknowledged", null, false, listOf()),
    236L to OpcodeMeta(236L, "CALL_TURN_FETCH", 10, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "CallTurnFetch", "CallTurnResponse", null, false, listOf()),
    237L to OpcodeMeta(237L, "CALL_SFU_JOIN", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "CallInvite", "CallTurnResponse", null, false, listOf()),
    238L to OpcodeMeta(238L, "CALL_SFU_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "CallStateEvent", null, "call_id", false, listOf()),
    52L to OpcodeMeta(52L, "CONVERSATION_STATE_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "ConversationStateEvent", null, "conversation_id", false, listOf()),
    239L to OpcodeMeta(239L, "STORE_PURCHASE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "StorePurchase", "StorePurchaseResult", null, false, listOf()),
    240L to OpcodeMeta(240L, "ENTITLEMENTS", 1, DeliveryClass.Droppable, AuthLevel.User, Direction.ClientToServer, false, "EntitlementsReq", "EntitlementsResponse", null, false, listOf()),
    168L to OpcodeMeta(168L, "KICK_POINTS_BUY", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "KickPointsBuy", "KickPointsBuyResult", null, false, listOf()),
)
