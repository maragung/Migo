...
val OPCODES: Map<Long, OpcodeMeta> = mapOf(
    ...
    39L to OpcodeMeta(39L, "TYPING", 1, DeliveryClass.Coalescable, AuthLevel.User, Direction.Both, false, "TypingEvent", null, "conversation_id", false, listOf("UltraLowData"), "TYPING"),
    ...
    64L to OpcodeMeta(64L, "PRESENCE_SET", 1, DeliveryClass.Coalescable, AuthLevel.User, Direction.ClientToServer, false, "PresenceUpdate", "Acknowledged", null, false, listOf(), "PRESENCE"),
    65L to OpcodeMeta(65L, "PRESENCE_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "PresenceEvent", null, "user_id", true, listOf(), "PRESENCE"),
    80L to OpcodeMeta(80L, "ROOM_JOIN", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomJoinRequest", "RoomJoinResponse", null, false, listOf(), "ROOMS"),
    81L to OpcodeMeta(81L, "ROOM_LEAVE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomLeaveRequest", "Acknowledged", null, false, listOf(), "ROOMS"),
    82L to OpcodeMeta(82L, "ROOM_LIST", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomListRequest", "RoomListResponse", null, false, listOf(), "ROOMS"),
    83L to OpcodeMeta(83L, "ROOM_MEMBER_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "RoomMemberEvent", null, null, false, listOf(), "ROOMS"),
    84L to OpcodeMeta(84L, "ROOM_STATE_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "RoomStateEvent", null, "room_id", false, listOf(), "ROOMS"),
    85L to OpcodeMeta(85L, "ROOM_CREATE", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomCreate", "RoomJoinResponse", null, false, listOf(), "ROOMS"),
    86L to OpcodeMeta(86L, "ROOM_ROSTER", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RosterReq", "RosterResponse", null, false, listOf(), "ROOMS"),
    87L to OpcodeMeta(87L, "ROOM_ROLE_SET", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomRoleSet", "Acknowledged", null, false, listOf(), "ROOMS"),
    88L to OpcodeMeta(88L, "ROOM_UPDATE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomUpdate", "Acknowledged", null, false, listOf(), "ROOMS"),
    89L to OpcodeMeta(89L, "ROOM_ARCHIVE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomArchive", "Acknowledged", null, false, listOf(), "ROOMS"),
    90L to OpcodeMeta(90L, "ROOM_VOTE_KICK", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomVoteKick", "RoomVoteKickResponse", null, false, listOf(), "ROOMS"),
    91L to OpcodeMeta(91L, "ROOM_VOTE_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "RoomVoteEvent", null, "room_id", false, listOf(), "ROOMS"),
    92L to OpcodeMeta(92L, "ROOM_SANCTION", 10, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomSanction", "Acknowledged", null, false, listOf(), "ROOMS"),
    ...
    160L to OpcodeMeta(160L, "GIFT_SEND", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GiftSend", "GiftSendResult", null, false, listOf(), "ECONOMY"),
    161L to OpcodeMeta(161L, "BALANCE_FETCH", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "WalletReq", "WalletView", null, false, listOf(), "ECONOMY"),
    162L to OpcodeMeta(162L, "ECONOMY_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "EconomyEvent", null, null, false, listOf(), "ECONOMY"),
    163L to OpcodeMeta(163L, "GIFT_CATALOGUE", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GiftCatalogueReq", "GiftCatalogueResponse", null, false, listOf(), "ECONOMY"),
    164L to OpcodeMeta(164L, "LEDGER_HISTORY", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "LedgerReq", "LedgerResponse", null, false, listOf(), "ECONOMY"),
    165L to OpcodeMeta(165L, "PROGRESSION", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ProgressionReq", "ProgressionWire", null, false, listOf(), "ECONOMY"),
    166L to OpcodeMeta(166L, "BADGES", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "BadgesReq", "BadgesResponse", null, false, listOf(), "ECONOMY"),
    167L to OpcodeMeta(167L, "LEADERBOARD", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "LeaderboardReq", "LeaderboardResponse", null, false, listOf(), "ECONOMY"),
    176L to OpcodeMeta(176L, "GAME_ACTION", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GameAction", "Acknowledged", null, false, listOf(), "GAMES"),
    177L to OpcodeMeta(177L, "GAME_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "GameEvent", null, null, false, listOf(), "GAMES"),
    ...
    186L to OpcodeMeta(186L, "GAME_CATALOGUE", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GiftCatalogueReq", "GameCatalogueResponse", null, false, listOf(), "GAMES"),
    ...
    227L to OpcodeMeta(227L, "CALL_DECLINE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "CallDecline", "Acknowledged", null, false, listOf(), "CALLS"),
    228L to OpcodeMeta(228L, "CALL_CANCEL", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "CallCancel", "Acknowledged", null, false, listOf(), "CALLS"),
    229L to OpcodeMeta(229L, "CALL_END", 2, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "CallEnd", "Acknowledged", null, false, listOf(), "CALLS"),
    230L to OpcodeMeta(230L, "CALL_SDP", 3, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "CallSdp", "Acknowledged", null, false, listOf(), "CALLS"),
    231L to OpcodeMeta(231L, "CALL_ICE", 1, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "CallIce", "Acknowledged", null, false, listOf(), "CALLS"),
    232L to OpcodeMeta(232L, "CALL_STATE_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "CallStateEvent", null, null, false, listOf(), "CALLS"),
    233L to OpcodeMeta(233L, "CALL_RENEGOTIATE", 3, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "CallRenegotiate", "Acknowledged", null, false, listOf(), "CALLS"),
    234L to OpcodeMeta(234L, "CALL_KEY_UPDATE", 3, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "CallKeyUpdate", "Acknowledged", null, false, listOf(), "CALLS"),
    235L to OpcodeMeta(235L, "CALL_STATS", 1, DeliveryClass.Droppable, AuthLevel.User, Direction.ClientToServer, false, "CallStats", "Acknowledged", null, false, listOf(), "CALLS"),
    ...
    168L to OpcodeMeta(168L, "KICK_POINTS_BUY", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "KickPointsBuy", "KickPointsBuyResult", null, false, listOf(), "ECONOMY"),
)
