...
val OPCODES: Map<Long, OpcodeMeta> = mapOf(
    1L to OpcodeMeta(1L, "HELLO", 5, DeliveryClass.Critical, AuthLevel.None, Direction.ClientToServer, false, "Hello", "Welcome", null, null),
    2L to OpcodeMeta(2L, "PING", 1, DeliveryClass.Critical, AuthLevel.None, Direction.Both, false, "Ping", "Pong", null, null),
    3L to OpcodeMeta(3L, "ACK", 0, DeliveryClass.Critical, AuthLevel.None, Direction.ClientToServer, false, "Ack", null, null, null),
    4L to OpcodeMeta(4L, "ERROR", 0, DeliveryClass.Critical, AuthLevel.None, Direction.ServerToClient, false, "Error", null, null, null),
    5L to OpcodeMeta(5L, "RECONNECT_HINT", 0, DeliveryClass.Critical, AuthLevel.None, Direction.ServerToClient, false, "ReconnectHint", null, null, null),
    6L to OpcodeMeta(6L, "AUTHENTICATE", 10, DeliveryClass.Critical, AuthLevel.None, Direction.ClientToServer, false, "Authenticate", "Authenticated", null, null),
    7L to OpcodeMeta(7L, "SUBSCRIBE", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "SubscribeRequest", "SubscribeResponse", null, null),
    8L to OpcodeMeta(8L, "UNSUBSCRIBE", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "SubscribeRequest", "SubscribeResponse", null, null),
    16L to OpcodeMeta(16L, "KEY_PUBLISH", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "KeyPublish", "KeyPublishResult", null, null),
    17L to OpcodeMeta(17L, "KEY_BUNDLE_FETCH", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "KeyBundleRequest", "KeyBundleResponse", null, null),
    32L to OpcodeMeta(32L, "MESSAGE_SEND", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MessageSend", "MessageAccepted", null, null),
    33L to OpcodeMeta(33L, "MESSAGE_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, true, "MessageEvent", null, null, null),
    34L to OpcodeMeta(34L, "MESSAGE_RECEIPT", 1, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "MessageReceipt", null, null, null),
    35L to OpcodeMeta(35L, "MESSAGE_DELETE", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MessageDelete", "MessageAccepted", null, null),
    36L to OpcodeMeta(36L, "SYNC", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "SyncRequest", "SyncResponse", null, null),
    37L to OpcodeMeta(37L, "CONVERSATION_LIST", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationListRequest", "ConversationListResponse", null, null),
    38L to OpcodeMeta(38L, "CONVERSATION_CREATE", 10, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationCreateRequest", "ConversationSummary", null, null),
    39L to OpcodeMeta(39L, "TYPING", 1, DeliveryClass.Coalescable, AuthLevel.User, Direction.Both, false, "TypingEvent", null, "conversation_id", null),
    40L to OpcodeMeta(40L, "MESSAGE_EDIT", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MessageEdit", "Acknowledged", null, null),
    41L to OpcodeMeta(41L, "REACTION_SET", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ReactionSet", "Acknowledged", null, null),
    42L to OpcodeMeta(42L, "REACTION_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "ReactionEvent", null, "target_message_id+actor_id", null),
    43L to OpcodeMeta(43L, "CONVERSATION_INVITE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationInviteRequest", "ConversationSummary", null, null),
    44L to OpcodeMeta(44L, "CONVERSATION_LEAVE", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationLeaveRequest", "Acknowledged", null, null),
    45L to OpcodeMeta(45L, "CONVERSATION_ROSTER", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationRosterRequest", "ConversationRosterResponse", null, null),
    46L to OpcodeMeta(46L, "CONVERSATION_MUTE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationMuteRequest", "Acknowledged", null, null),
    47L to OpcodeMeta(47L, "CONVERSATION_KICK", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationKickRequest", "Acknowledged", null, null),
    48L to OpcodeMeta(48L, "CONVERSATION_VOTE_KICK", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationVoteKickRequest", "ConversationVoteKickResponse", null, null),
    49L to OpcodeMeta(49L, "CONVERSATION_VOTE_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "ConversationVoteEvent", null, "conversation_id", null),
    50L to OpcodeMeta(50L, "CONVERSATION_MEMBER_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "ConversationMemberEvent", null, null, null),
    51L to OpcodeMeta(51L, "CONVERSATION_UPDATE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ConversationUpdateRequest", "ConversationSummary", null, null),
    64L to OpcodeMeta(64L, "PRESENCE_SET", 1, DeliveryClass.Coalescable, AuthLevel.User, Direction.ClientToServer, false, "PresenceUpdate", "Acknowledged", null, null),
    65L to OpcodeMeta(65L, "PRESENCE_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "PresenceEvent", null, "user_id", null),
    80L to OpcodeMeta(80L, "ROOM_JOIN", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomJoinRequest", "RoomJoinResponse", null, null),
    81L to OpcodeMeta(81L, "ROOM_LEAVE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomLeaveRequest", "Acknowledged", null, null),
    82L to OpcodeMeta(82L, "ROOM_LIST", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomListRequest", "RoomListResponse", null, null),
    83L to OpcodeMeta(83L, "ROOM_MEMBER_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "RoomMemberEvent", null, null, null),
    84L to OpcodeMeta(84L, "ROOM_STATE_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "RoomStateEvent", null, "room_id", null),
    85L to OpcodeMeta(85L, "ROOM_CREATE", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomCreate", "RoomJoinResponse", null, null),
    86L to OpcodeMeta(86L, "ROOM_ROSTER", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RosterReq", "RosterResponse", null, null),
    87L to OpcodeMeta(87L, "ROOM_ROLE_SET", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomRoleSet", "Acknowledged", null, null),
    88L to OpcodeMeta(88L, "ROOM_UPDATE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomUpdate", "Acknowledged", null, null),
    89L to OpcodeMeta(89L, "ROOM_ARCHIVE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomArchive", "Acknowledged", null, null),
    90L to OpcodeMeta(90L, "ROOM_VOTE_KICK", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomVoteKick", "RoomVoteKickResponse", null, null),
    91L to OpcodeMeta(91L, "ROOM_VOTE_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "RoomVoteEvent", null, "room_id", null),
    92L to OpcodeMeta(92L, "ROOM_SANCTION", 10, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RoomSanction", "Acknowledged", null, null),
    111L to OpcodeMeta(111L, "PROFILE_UPDATE", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ProfileUpdate", "UserProfile", null, null),
    112L to OpcodeMeta(112L, "PROFILE_FETCH", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ProfileRequest", "ProfileResponse", null, null),
    113L to OpcodeMeta(113L, "FRIEND_REQUEST", 10, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "FriendTarget", "Acknowledged", null, null),
    114L to OpcodeMeta(114L, "FRIEND_RESPOND", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "FriendRespond", "Acknowledged", null, null),
    115L to OpcodeMeta(115L, "FRIEND_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "FriendEvent", null, null, null),
    116L to OpcodeMeta(116L, "BLOCK_SET", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "FriendTarget", "Acknowledged", null, null),
    117L to OpcodeMeta(117L, "RELATIONSHIP_LIST", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "RelationshipListReq", "RelationshipList", null, null),
    118L to OpcodeMeta(118L, "SUGGESTIONS", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "SuggestReq", "SearchResponse", null, null),
    119L to OpcodeMeta(119L, "SEARCH", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "SearchReq", "SearchResponse", null, null),
    120L to OpcodeMeta(120L, "MUTE_SET", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MuteSet", "Acknowledged", null, null),
    128L to OpcodeMeta(128L, "MEDIA_UPLOAD_BEGIN", 10, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MediaBegin", "MediaTicket", null, null),
    129L to OpcodeMeta(129L, "MEDIA_UPLOAD_STATUS", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MediaStatusReq", "MediaProgress", null, null),
    130L to OpcodeMeta(130L, "MEDIA_UPLOAD_COMMIT", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MediaCommit", "Acknowledged", null, null),
    131L to OpcodeMeta(131L, "MEDIA_UPLOAD_ABORT", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MediaAbort", "Acknowledged", null, null),
    132L to OpcodeMeta(132L, "MEDIA_FETCH_URL", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "MediaFetch", "MediaUrl", null, null),
    133L to OpcodeMeta(133L, "MEDIA_STATE_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "MediaStateEvent", null, "object_id", null),
    144L to OpcodeMeta(144L, "NOTIFICATION_EVENT", 0, DeliveryClass.Droppable, AuthLevel.User, Direction.ServerToClient, false, "NotificationEvent", null, null, null),
    145L to OpcodeMeta(145L, "NOTIFICATION_ACK", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "NotificationAck", "Acknowledged", null, null),
    146L to OpcodeMeta(146L, "NOTIFICATION_LIST", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "InboxReq", "InboxResponse", null, null),
    147L to OpcodeMeta(147L, "PUSH_REGISTER", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "PushRegister", "Acknowledged", null, null),
    148L to OpcodeMeta(148L, "PUSH_UNREGISTER", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "PushUnregister", "Acknowledged", null, null),
    160L to OpcodeMeta(160L, "GIFT_SEND", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GiftSend", "GiftSendResult", null, null),
    161L to OpcodeMeta(161L, "BALANCE_FETCH", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "WalletReq", "WalletView", null, null),
    162L to OpcodeMeta(162L, "ECONOMY_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "EconomyEvent", null, null, null),
    163L to OpcodeMeta(163L, "GIFT_CATALOGUE", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GiftCatalogueReq", "GiftCatalogueResponse", null, null),
    164L to OpcodeMeta(164L, "LEDGER_HISTORY", 3, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "LedgerReq", "LedgerResponse", null, null),
    165L to OpcodeMeta(165L, "PROGRESSION", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ProgressionReq", "ProgressionWire", null, null),
    166L to OpcodeMeta(166L, "BADGES", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "BadgesReq", "BadgesResponse", null, null),
    167L to OpcodeMeta(167L, "LEADERBOARD", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "LeaderboardReq", "LeaderboardResponse", null, null),
    176L to OpcodeMeta(176L, "GAME_ACTION", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GameAction", "Acknowledged", null, null),
    177L to OpcodeMeta(177L, "GAME_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "GameEvent", null, null, null),
    178L to OpcodeMeta(178L, "BOT_COMMAND", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "BotCommand", "Acknowledged", null, null),
    179L to OpcodeMeta(179L, "BOT_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "BotEvent", null, null, null),
    180L to OpcodeMeta(180L, "BOT_REGISTER", 20, DeliveryClass.Critical, AuthLevel.Bot, Direction.ClientToServer, false, "BotRegister", "BotView", null, null),
    183L to OpcodeMeta(183L, "GAME_START", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GameStart", "GameViewWire", null, null),
    184L to OpcodeMeta(184L, "GAME_VIEW", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GameId", "GameViewWire", null, null),
    185L to OpcodeMeta(185L, "GAME_ABANDON", 2, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GameId", "Acknowledged", null, null),
    186L to OpcodeMeta(186L, "GAME_CATALOGUE", 1, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "GiftCatalogueReq", "GameCatalogueResponse", null, null),
    192L to OpcodeMeta(192L, "REPORT_CREATE", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ReportFile", "Acknowledged", null, null),
    193L to OpcodeMeta(193L, "MODERATION_ACTION", 10, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "ModAction", "Acknowledged", null, null),
    194L to OpcodeMeta(194L, "MODERATION_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "ModerationEvent", null, null, null),
    208L to OpcodeMeta(208L, "FED_HELLO", 5, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedHello", "FedHello", null, "FEDERATION"),
    209L to OpcodeMeta(209L, "FED_AUTH", 5, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedAuth", "Acknowledged", null, "FEDERATION"),
    210L to OpcodeMeta(210L, "FED_PING", 1, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedPing", "FedPong", null, "FEDERATION"),
    211L to OpcodeMeta(211L, "FED_FORWARD", 1, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedForward", "Acknowledged", null, "FEDERATION"),
    212L to OpcodeMeta(212L, "FED_ACK", 0, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedAck", "Acknowledged", null, "FEDERATION"),
    213L to OpcodeMeta(213L, "FED_ROOM_SUBSCRIBE", 2, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedRouting", "Acknowledged", null, "FEDERATION"),
    214L to OpcodeMeta(214L, "FED_ROOM_EVENT", 0, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedRoomEvent", "Acknowledged", null, "FEDERATION"),
    215L to OpcodeMeta(215L, "FED_PRESENCE_DIGEST", 0, DeliveryClass.Coalescable, AuthLevel.Server, Direction.Both, false, "FedPresenceDigest", "Acknowledged", "region", "FEDERATION"),
    216L to OpcodeMeta(216L, "FED_KEY_ROTATE", 5, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedKeyRotate", "Acknowledged", null, "FEDERATION"),
    217L to OpcodeMeta(217L, "FED_HEALTH", 1, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedHealth", "FedHealth", null, "FEDERATION"),
    218L to OpcodeMeta(218L, "FED_SHARD_MAP", 2, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedShardMap", "Acknowledged", null, "FEDERATION"),
    219L to OpcodeMeta(219L, "FED_ERROR", 0, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedError", "Acknowledged", null, "FEDERATION"),
    220L to OpcodeMeta(220L, "FED_CALL_RELAY", 1, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedForward", "Acknowledged", null, "FEDERATION"),
    221L to OpcodeMeta(221L, "FED_DIRECTORY", 2, DeliveryClass.Critical, AuthLevel.Server, Direction.Both, false, "FedDirectoryReq", "FedDirectory", null, "FEDERATION"),
    224L to OpcodeMeta(224L, "CALL_INVITE", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "CallInvite", "CallInviteResult", null, null),
    225L to OpcodeMeta(225L, "CALL_INVITE_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "CallInviteEvent", null, null, null),
    226L to OpcodeMeta(226L, "CALL_ANSWER", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "CallAnswer", "Acknowledged", null, null),
    227L to OpcodeMeta(227L, "CALL_DECLINE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "CallDecline", "Acknowledged", null, null),
    228L to OpcodeMeta(228L, "CALL_CANCEL", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "CallCancel", "Acknowledged", null, null),
    229L to OpcodeMeta(229L, "CALL_END", 2, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "CallEnd", "Acknowledged", null, null),
    230L to OpcodeMeta(230L, "CALL_SDP", 3, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "CallSdp", "Acknowledged", null, null),
    231L to OpcodeMeta(231L, "CALL_ICE", 1, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "CallIce", "Acknowledged", null, null),
    232L to OpcodeMeta(232L, "CALL_STATE_EVENT", 0, DeliveryClass.Critical, AuthLevel.User, Direction.ServerToClient, false, "CallStateEvent", null, null, null),
    233L to OpcodeMeta(233L, "CALL_RENEGOTIATE", 3, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "CallRenegotiate", "Acknowledged", null, null),
    234L to OpcodeMeta(234L, "CALL_KEY_UPDATE", 3, DeliveryClass.Critical, AuthLevel.User, Direction.Both, false, "CallKeyUpdate", "Acknowledged", null, null),
    235L to OpcodeMeta(235L, "CALL_STATS", 1, DeliveryClass.Droppable, AuthLevel.User, Direction.ClientToServer, false, "CallStats", "Acknowledged", null, null),
    236L to OpcodeMeta(236L, "CALL_TURN_FETCH", 10, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "CallTurnFetch", "CallTurnResponse", null, null),
    237L to OpcodeMeta(237L, "CALL_SFU_JOIN", 20, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "CallInvite", "CallTurnResponse", null, null),
    238L to OpcodeMeta(238L, "CALL_SFU_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "CallStateEvent", null, "call_id", null),
    52L to OpcodeMeta(52L, "CONVERSATION_STATE_EVENT", 0, DeliveryClass.Coalescable, AuthLevel.User, Direction.ServerToClient, false, "ConversationStateEvent", null, "conversation_id", null),
    239L to OpcodeMeta(239L, "STORE_PURCHASE", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "StorePurchase", "StorePurchaseResult", null, null),
    240L to OpcodeMeta(240L, "ENTITLEMENTS", 1, DeliveryClass.Droppable, AuthLevel.User, Direction.ClientToServer, false, "EntitlementsReq", "EntitlementsResponse", null, null),
    168L to OpcodeMeta(168L, "KICK_POINTS_BUY", 5, DeliveryClass.Critical, AuthLevel.User, Direction.ClientToServer, false, "KickPointsBuy", "KickPointsBuyResult", null, null),
)
