 ...
 * roster joined from a thread header outlives the window it started in. Nothing connection-shaped
 * lives at this level any more: the transport's health is worn inline by the surfaces the shell
 * renders — the list windows' footer band and the desk taskbar's chip — so it never floats over
 * a chat window the way the corner dot once did.
 */
...
import { GroupCallManagerProvider } from '@/lib/migo/group-call-manager.js';
