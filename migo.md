...
Blok ini ada supaya penanda BUILT tidak pernah dilonggarkan. Sebelas crate berikut sudah lengkap kodenya dan lulus cargo build, cargo clippy dengan --all-targets tanpa satu pun peringatan, serta cargo doc tanpa intra-doc link yang rusak, tetapi belum memiliki satu pun test. Menandainya BUILT akan melanggar aturan pemeliharaan di akhir section ini, sedangkan meninggalkannya di BELUM ADA KODE akan membuat orang menulis ulang kode yang sudah ada. Test integrasi untuk kesebelasnya ditulis pada satu tahap tersendiri setelah seluruh crate layer 3, layer 4, dan layer 5 selesai, dan pada saat itu kesebelas baris ini berpindah ke blok BUILT.
