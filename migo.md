...
STATUS: BUILD untuk v0.12.0. Keputusan arsitekturnya ada di ADR-0013, model ancamannya di docs/03-security-threat-model.md section 11, dan spesifikasi produknya di migo-update-1.md (file referensi pengguna, tidak dikomit). Bagian ini menempatkan desain itu ke dalam aturan yang sama dengan bagian lain dokumen ini.
...
STATUS: BUILD untuk v0.13.0. Keputusan arsitekturnya ada di ADR-0014; spesifikasi produknya di migo-update-1.md #40-#45 dan #58-#59 (file referensi pengguna, tidak dikomit). Bagian ini membuka apa yang sengaja ditutup section 182: saldo on-chain, pembangunan transaksi, dan broadcast — di atas jaringan EVM yang sama untuk semua klien.
