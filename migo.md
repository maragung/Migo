...
STATUS: BUILT untuk opcode media dan seluruh jalur servernya, yaitu ticket, commit, sniff magic byte, scan, dan PUT serta GET data plane di migo-api, dengan web yang mengunggah dan mengunduh media tersegel di bawah kunci percakapan; kebijakan sudah final. STATUS: SPEC untuk rendering media di client native, yang masih menggambar avatar sebagai monogram dan belum menampilkan attachment.
