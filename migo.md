...
Feature bit yang behavioral pada node ini adalah CALLS yang selalu diiklankan beserta QUIC dan TCP_TRANSPORT yang diiklankan hanya selama listenernya hidup, dan BandwidthMode yang bukan feature bit namun kini dibaca gateway dari HELLO, disimpan pada session handle, dan sampai ke Caller presence sehingga kadensi heartbeat menurut mode (section 75), sedangkan bit lainnya sudah di-codegen dan dinegosiasikan handshake tetapi belum menjadi saklar perilaku di dispatch mana pun (section 148)
