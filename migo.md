...
Antar node, presence dikirim sebagai digest teragregasi lewat FED_PRESENCE_DIGEST, bukan event per user
...
Presence antar node dikirim sebagai digest berkala dan teragregasi, bukan per perubahan per user. Presence lintas node adalah sumber traffic mesh terbesar bila dikirim mentah.
