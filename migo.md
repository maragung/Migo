...
Opcode yang direncanakan. STATUS: BUILT untuk seluruh range yang tercantum di atas, termasuk call 224 sampai 238 (SFU join 237 kini berjalan di server; lihat section 165). Metadata block section 141 dan flag bit 0x40 kini BUILT di codec dan registri flag. STATUS: SPEC untuk sisi client SFU group call (roster UI dan kunci frame antar peserta) yang belum memiliki kode client. Setiap opcode ditambahkan ke opcodes.json bersamaan dengan implementasi handler-nya, sesuai aturan alokasi section 146.
