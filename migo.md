...
NOTIFICATION_EVENT bernomor 144, yaitu satu-satunya dari 29 opcode IDL yang belum pernah menyentuh kabel, sebab migo-social sudah menyusun Notice di atasnya tetapi opcode 113 sampai 117 yang akan memicunya masih SPEC sehingga tidak ada tempat yang menyiarkannya; kedua puluh delapan sisanya sudah hidup, yaitu 21 opcode client-to-server yang seluruhnya terutekan dan 7 opcode server-to-client yang benar-benar disiarkan
Struct notification, yaitu satu-satunya kelompok struct yang di-codegen tanpa satu pun pemakai, sedangkan struct handshake, messaging, presence, room, key, profile, dan game semuanya sudah dipakai handler
Feature bit 0 sampai 15, yaitu konstanta yang sudah di-codegen dan dinegosiasikan handshake tetapi belum satu pun yang mengubah perilaku server
