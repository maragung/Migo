...
export const OPCODES: Readonly<Record<number, OpcodeMeta>> = {
  ...
  39: { code: 39, name: 'TYPING', cost: 1, cls: 'Coalescable', auth: 'User', direction: 'both', ackRequired: false, payload: 'TypingEvent', coalesceKey: 'conversation_id', paced: false, suppressOn: ['UltraLowData'], feature: 'TYPING' },
  ...
  81: { code: 81, name: 'ROOM_LEAVE', cost: 5, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'RoomLeaveRequest', response: 'Acknowledged', paced: false, suppressOn: [], feature: 'ROOMS' },
  82: { code: 82, name: 'ROOM_LIST', cost: 5, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'RoomListRequest', response: 'RoomListResponse', paced: false, suppressOn: [], feature: 'ROOMS' },
  83: { code: 83, name: 'ROOM_MEMBER_EVENT', cost: 0, cls: 'Critical', auth: 'User', direction: 'server_to_client', ackRequired: false, payload: 'RoomMemberEvent', paced: false, suppressOn: [], feature: 'ROOMS' },
  84: { code: 84, name: 'ROOM_STATE_EVENT', cost: 0, cls: 'Coalescable', auth: 'User', direction: 'server_to_client', ackRequired: false, payload: 'RoomStateEvent', coalesceKey: 'room_id', paced: false, suppressOn: [], feature: 'ROOMS' },
  85: { code: 85, name: 'ROOM_CREATE', cost: 20, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'RoomCreate', response: 'RoomJoinResponse', paced: false, suppressOn: [], feature: 'ROOMS' },
  86: { code: 86, name: 'ROOM_ROSTER', cost: 3, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'RosterReq', response: 'RosterResponse', paced: false, suppressOn: [], feature: 'ROOMS' },
  87: { code: 87, name: 'ROOM_ROLE_SET', cost: 5, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'RoomRoleSet', response: 'Acknowledged', paced: false, suppressOn: [], feature: 'ROOMS' },
  88: { code: 88, name: 'ROOM_UPDATE', cost: 5, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'RoomUpdate', response: 'Acknowledged', paced: false, suppressOn: [], feature: 'ROOMS' },
  89: { code: 89, name: 'ROOM_ARCHIVE', cost: 5, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'RoomArchive', response: 'Acknowledged', paced: false, suppressOn: [], feature: 'ROOMS' },
  90: { code: 90, name: 'ROOM_VOTE_KICK', cost: 5, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'RoomVoteKick', response: 'RoomVoteKickResponse', paced: false, suppressOn: [], feature: 'ROOMS' },
  91: { code: 91, name: 'ROOM_VOTE_EVENT', cost: 0, cls: 'Coalescable', auth: 'User', direction: 'server_to_client', ackRequired: false, payload: 'RoomVoteEvent', coalesceKey: 'room_id', paced: false, suppressOn: [], feature: 'ROOMS' },
  92: { code: 92, name: 'ROOM_SANCTION', cost: 10, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'RoomSanction', response: 'Acknowledged', paced: false, suppressOn: [], feature: 'ROOMS' },
  ...
  160: { code: 160, name: 'GIFT_SEND', cost: 20, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'GiftSend', response: 'GiftSendResult', paced: false, suppressOn: [], feature: 'ECONOMY' },
  161: { code: 161, name: 'BALANCE_FETCH', cost: 3, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'WalletReq', response: 'WalletView', paced: false, suppressOn: [], feature: 'ECONOMY' },
  162: { code: 162, name: 'ECONOMY_EVENT', cost: 0, cls: 'Critical', auth: 'User', direction: 'server_to_client', ackRequired: false, payload: 'EconomyEvent', paced: false, suppressOn: [], feature: 'ECONOMY' },
  163: { code: 163, name: 'GIFT_CATALOGUE', cost: 1, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'GiftCatalogueReq', response: 'GiftCatalogueResponse', paced: false, suppressOn: [], feature: 'ECONOMY' },
  164: { code: 164, name: 'LEDGER_HISTORY', cost: 3, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'LedgerReq', response: 'LedgerResponse', paced: false, suppressOn: [], feature: 'ECONOMY' },
  165: { code: 165, name: 'PROGRESSION', cost: 2, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'ProgressionReq', response: 'ProgressionWire', paced: false, suppressOn: [], feature: 'ECONOMY' },
  166: { code: 166, name: 'BADGES', cost: 2, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'BadgesReq', response: 'BadgesResponse', paced: false, suppressOn: [], feature: 'ECONOMY' },
  167: { code: 167, name: 'LEADERBOARD', cost: 5, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'LeaderboardReq', response: 'LeaderboardResponse', paced: false, suppressOn: [], feature: 'ECONOMY' },
  176: { code: 176, name: 'GAME_ACTION', cost: 2, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'GameAction', response: 'Acknowledged', paced: false, suppressOn: [], feature: 'GAMES' },
  177: { code: 177, name: 'GAME_EVENT', cost: 0, cls: 'Critical', auth: 'User', direction: 'server_to_client', ackRequired: false, payload: 'GameEvent', paced: false, suppressOn: [], feature: 'GAMES' },
  ...
  186: { code: 186, name: 'GAME_CATALOGUE', cost: 1, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'GiftCatalogueReq', response: 'GameCatalogueResponse', paced: false, suppressOn: [], feature: 'GAMES' },
  ...
  227: { code: 227, name: 'CALL_DECLINE', cost: 5, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'CallDecline', response: 'Acknowledged', paced: false, suppressOn: [], feature: 'CALLS' },
  228: { code: 228, name: 'CALL_CANCEL', cost: 5, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'CallCancel', response: 'Acknowledged', paced: false, suppressOn: [], feature: 'CALLS' },
  229: { code: 229, name: 'CALL_END', cost: 2, cls: 'Critical', auth: 'User', direction: 'both', ackRequired: false, payload: 'CallEnd', response: 'Acknowledged', paced: false, suppressOn: [], feature: 'CALLS' },
  230: { code: 230, name: 'CALL_SDP', cost: 3, cls: 'Critical', auth: 'User', direction: 'both', ackRequired: false, payload: 'CallSdp', response: 'Acknowledged', paced: false, suppressOn: [], feature: 'CALLS' },
  231: { code: 231, name: 'CALL_ICE', cost: 1, cls: 'Critical', auth: 'User', direction: 'both', ackRequired: false, payload: 'CallIce', response: 'Acknowledged', paced: false, suppressOn: [], feature: 'CALLS' },
  232: { code: 232, name: 'CALL_STATE_EVENT', cost: 0, cls: 'Critical', auth: 'User', direction: 'server_to_client', ackRequired: false, payload: 'CallStateEvent', paced: false, suppressOn: [], feature: 'CALLS' },
  233: { code: 233, name: 'CALL_RENEGOTIATE', cost: 3, cls: 'Critical', auth: 'User', direction: 'both', ackRequired: false, payload: 'CallRenegotiate', response: 'Acknowledged', paced: false, suppressOn: [], feature: 'CALLS' },
  234: { code: 234, name: 'CALL_KEY_UPDATE', cost: 3, cls: 'Critical', auth: 'User', direction: 'both', ackRequired: false, payload: 'CallKeyUpdate', response: 'Acknowledged', paced: false, suppressOn: [], feature: 'CALLS' },
  235: { code: 235, name: 'CALL_STATS', cost: 1, cls: 'Droppable', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'CallStats', response: 'Acknowledged', paced: false, suppressOn: [], feature: 'CALLS' },
  ...
  168: { code: 168, name: 'KICK_POINTS_BUY', cost: 5, cls: 'Critical', auth: 'User', direction: 'client_to_server', ackRequired: false, payload: 'KickPointsBuy', response: 'KickPointsBuyResult', paced: false, suppressOn: [], feature: 'ECONOMY' },
};
