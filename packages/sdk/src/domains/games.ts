...
export class GamesDomain {
   ...
   * that refusal is surfaced here as a {@link RemoteError}. The server publishes a `started`
   * {@link GameEvent} to the conversation for everyone else — the reply already carries the
