...
//! in `migo-cache`'s contracts, media unavailability in `migo-media`'s. The gap this
//! file cannot close — the absent handshake timeout — is recorded in the brief rather
